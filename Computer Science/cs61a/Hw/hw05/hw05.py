...
def make_withdraw(balance, password):
    ...
    def withdraw(amount, password_attemp):
        ...
        if len(attempts) >= 3:
            ...
            attempts.append(password_attemp)
...
def make_joint(withdraw, old_password, new_password):
    ...
    if type(value) == str:
         return value
    def withdraw2(balance, password_attemp):
        if password_attemp == old_password or password_attemp == new_password:
            return withdraw(balance, old_password)
        return withdraw(balance, password_attemp)
    return withdraw2
...
def generate_paths(t, x):
    ...
    def path(t,lst):
        ...
        for branch in branches(t):
            yield from path (branch,lst +[label(t)])
    return path(t,[])
    #use genatgor recurively , yield in recurisive func
